...
<script type="text/javascript" src="../js/jquery.coda-slider-2.0.js"></script>
	...
	<div class="content">
		<div class="page">
		<h2>Learn about some of our previous team members:</h2>
...
<div class="coda-slider-wrapper">
	...
	<div class="panel" id="vivan">
		<div class="panel-wrapper">
			...
			<h3 class="title">Co-chair of Conference</h3>
			<p>Vivian is a second year student at the University of Chicago majoring in Economics and Political Science. Having studied in the United Kingdom and Hong Kong and volunteered in Morocco before coming to Chicago, Vivian has great exposure to a wide range of cultural experiences and fully understands local issues of various parts of the world.</p>
			<p>Outside classes, Vivian is also a member of the Rockefeller Chapel Choir. Vivianalso cares deeply about the community. This is why she is elected Social Chair for the Hong Kong Students Association to help bond Hong Kong students with the wider college community. She is also an active member of the Chicago Society, where she helps organize on-campus events to raise awareness of interesting economic and political issues.</p>
			<p>Vivian has long wanted to contribute to the development of the poorer countries since her volunteering experience in Morocco, and this passion brought her to Envision Do last year. With little prior experience in developmental works, the short period of time at Envision Do has already made Vivian more matured onserious topics of economic and social development, and she is keen to bring her learning to make an impact.</p></div>
	</div>
